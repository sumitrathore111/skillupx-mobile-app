...
const S = StyleSheet.create({
  ...
  header:        { flexDirection: 'row', alignItems: 'flex-start', paddingHorizontal: 10, paddingTop: 12, paddingBottom: 14, gap: 12, overflow: 'hidden' },
  ...
  tabBar:        { flexDirection: 'row', marginHorizontal: 10, marginBottom: 8, backgroundColor: COLORS.surface, borderRadius: RADIUS.lg, padding: 3, borderWidth: 1, borderColor: COLORS.border },
  ...
  searchBox:    { flexDirection: 'row', alignItems: 'center', gap: 8, marginHorizontal: 10, marginBottom: 8, backgroundColor: COLORS.surface, borderRadius: RADIUS.md, borderWidth: 1, borderColor: COLORS.border, paddingHorizontal: 12 },
  searchInput:  { flex: 1, height: 42, color: COLORS.textPrimary, fontSize: 14 },

  chipRow:      { paddingHorizontal: 16, gap: 6, paddingBottom: 2 },
  chipGrid:     { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 10, gap: 6, marginBottom: 4 },
  ...
  filterRow:         { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10, marginTop: 8, marginBottom: 6 },
  ...
  list: { paddingVertical: 8, paddingHorizontal: 0, gap: 14, paddingBottom: 40 },

  card: { backgroundColor: GLASS, borderRadius: 0, borderWidth: 1, borderColor: GLASS_BORDER, padding: 14, borderLeftWidth: 0, borderRightWidth: 0, ...SHADOWS.sm },
  ...
  subTabRow:       { flexDirection: 'row', marginHorizontal: 10, marginBottom: 8, backgroundColor: COLORS.surface, borderRadius: RADIUS.lg, padding: 3, borderWidth: 1, borderColor: COLORS.border },
