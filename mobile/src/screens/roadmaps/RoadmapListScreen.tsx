  ...
  const renderListHeader = () => (
    <View>
      ...
      <View style={{ paddingHorizontal: 10, marginBottom: 6 }}>
        <Text style={styles.countText}>{filteredRoadmaps.length} roadmaps</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 12 },
  ...
  statsRow: { flexDirection: 'row', marginHorizontal: 10, marginBottom: 12, gap: 8 },
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 10, marginBottom: 8, backgroundColor: COLORS.surface, borderRadius: RADIUS.md, borderWidth: 1, borderColor: COLORS.border, paddingHorizontal: 12, gap: 8 },
  searchInput: { flex: 1, height: 42, color: COLORS.textPrimary, fontSize: 14 },
  filterScroll: { paddingHorizontal: 10, paddingBottom: 8, gap: 8 },
  ...
  diffRow: { flexDirection: 'row', paddingHorizontal: 10, gap: 8, marginBottom: 8 },
  ...
  featuredSectionTitle: { fontSize: 16, fontWeight: '700', color: COLORS.textPrimary, marginBottom: 10, paddingHorizontal: 10 },
  ...
  list: { paddingVertical: 8, paddingHorizontal: 0, gap: 12, paddingBottom: 32 },
  countText: { fontSize: 12, color: COLORS.textMuted },
  card: { backgroundColor: COLORS.surface, borderRadius: 0, padding: 14, borderWidth: 1, borderColor: COLORS.border, borderLeftWidth: 0, borderRightWidth: 0 },
