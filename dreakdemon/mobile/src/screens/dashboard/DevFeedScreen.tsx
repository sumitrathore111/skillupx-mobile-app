...
export default function DevFeedScreen() {
  ...
  const loadData = useCallback(async (isRefresh = false) => {
    ...
    try {
      const [walletRes, battlesRes, ideasRes, projectsRes, profileRes] =
      ...
      >
        ...
        <View style={styles.topBar}>
          ...
          <View style={styles.headerRight}>
            <TouchableOpacity onPress={() => navigation.navigate('Query')} style={styles.iconBtn}>
              <Ionicons name="chatbubble-ellipses-outline" size={19} color={COLORS.textSecondary} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('MyInvites')} style={styles.iconBtn}>
