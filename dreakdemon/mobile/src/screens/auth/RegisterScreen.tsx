    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.form}>
          ...
          {[
            { label: 'Full Name', value: name, setter: setName, icon: 'person-outline', placeholder: 'John Doe', autoCapitalize: 'words' as const },
            { label: 'Username', value: username, setter: setUsername, icon: 'at-outline', placeholder: 'johndoe', autoCapitalize: 'none' as const },
            { label: 'Email', value: email, setter: setEmail, icon: 'mail-outline', placeholder: 'john@example.com', autoCapitalize: 'none' as const },
          ].map((field) => (
